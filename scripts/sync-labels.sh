...
merge-blocked	B60205	자동 검증 실패로 머지 차단 — PR 코멘트의 검증 오류 해소 후 라벨 제거 (JAC-2051)
hexagon-validation-failed	D93F0B	hexagon 검증 실패 — scripts/validate-hexagon-pr.mjs 출력 참조 (JAC-2051)
TSV
)
